...
''',
    ...
    "src/services/workspace_service.py": '''from pathlib import Path
...
''',
    ...
    "src/gui/pages/workspace_page.py": '''import tkinter as tk
...
class WorkspacePage(tk.Frame):
    def __init__(self, parent, app_state):
        ...
        self.title = tk.Label(
            self,
            text="Workspace Scanner & Project Explorer",
            font=("Arial", 18, "bold")
        )
        ...
        self.path_label = tk.Label(
            self,
            text=f"Workspace: {self.workspace_path}",
            font=("Arial", 10)
        )
...
''',
    ...
    "src/plugins/workspace_plugin.py": '''from plugins.base_plugin import BasePlugin
...
''',
    ...
    "README.md": '''# GH Workspace Manager

GH Workspace Manager is a professional modular desktop application for managing a GitHub-based local workspace.
